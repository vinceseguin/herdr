...
fn status_commands_report_client_and_server_versions() {
    ...
    assert!(
        full_stdout.contains(&format!("  version: {}", crate::support::build_version())),
        "stdout: {full_stdout}"
    );
    assert!(
    ...
    assert!(
        server_stdout.contains(&format!("version: {}", crate::support::build_version())),
        "stdout: {server_stdout}"
    );
    assert!(
    ...
    assert!(
        client_stdout.contains(&format!("version: {}", crate::support::build_version())),
    ...
    assert_eq!(server_json["version"], crate::support::build_version());
    ...
    assert_eq!(client_json["version"], crate::support::build_version());
